...
void DibujarHexagono(){
    ...
    Vector2 Puntos[]= {p1, p2, p3, p4, p5, p6};
    DrawTriangleFan(Puntos, 6, ORANGE);
    DrawLineV(p3,p1,BLACK);
    DrawLineV(p3,p5,BLACK);
    DrawLineV(p3,p6,BLACK);
}
...
int main(){
    ...
    while (!WindowShouldClose()) {
        ...
        DibujarEjes();
        DibujarHexagono();
        DrawText("GL_TRIANGLE_FAN Axel Irahola", 10, 10, 20, BLUE);
        EndDrawing();   
    }
